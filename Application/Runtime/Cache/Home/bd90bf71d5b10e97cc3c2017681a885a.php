...
<head>
	...
	var __URL = '/envmanage/index.php/Home/Attendance';
	...
	<div class="col-xs-12 col-md-12">
	        <div class="widget">
	            ...
	            <div class="widget-body">
	      			...
	      			<form action="/envmanage/index.php/Home/Attendance/showList" method="get" >
	                	...
	                	<div class="col-sm-2">
	                	  <?php if(!empty($info['am_time'])): ?><a class="btn" >上班打卡<?php echo ($info['am_time']); ?></a>
	                	  		<?php else: ?>
	                	  		<input href="/envmanage/index.php/Home/Attendance/add?type=am" is_have='no' class="btn btn-palegreen add_input" type="submit" value="上班打卡" ><?php endif; ?>
	                		
	                	</div>
		               <div class="col-sm-2">
	                	  <?php if(!empty($info['pm_time'])): ?><a class="btn" >下班打卡<?php echo ($info['pm_time']); ?></a>
	                	  		<?php else: ?>
	                	  		
	                	  		<input href="/envmanage/index.php/Home/Attendance/add?type=pm" is_have='no' class="btn btn-palegreen add_input" type="submit" value="下班打卡" ><?php endif; ?>
	                	</div>                	
	                ...
	                <table class="table table-striped table-hover table-bordered" id="editabledatatable">
	                    ...
	                    <tbody id="tapeListTable">
	                    	<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
		                        ...
		                        <td><?php echo ($vo["am_time"]); ?></td> 
		                        <td><?php echo ($vo["pm_time"]); ?></td>  
