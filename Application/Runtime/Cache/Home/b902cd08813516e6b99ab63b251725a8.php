             ...
             <div class="row">
                 <div class="col-xs-12">
                     <div class="widget radius-bordered">
    					 ...
    					 <form id='form_div' action="/envmanage/index.php/Home/BizProwled/save" method="post" enctype="multipart/form-data" ><!--  -->
			        					...
			        					<div class='row'>
		                                     ...
		                                     <div class="col-lg-3">
		                                         ...
		                                         <input  readonly="readonly"  type="text" class="form-control dateView " required="required"  name="date" id="date"   value="<?php echo ($info["date"]); ?>"  > 
		                                     </div>
					                    </div>
			        					<div class='row'>
		                                     ...
		                                     <div class="col-lg-3">
		                                      	...
		                                      	<select required="required"  id='business_id_select' name='business_id' >
					                    ...
					                    <div class='row'>
		                                     ...
		                                     <div class="col-lg-3">
		                                      	...
		                                      	<select  required="required"  id='prowled_obj_id_select' name='prowled_obj_id' >
					           			...
					           			<div class='row'>
		                                     ...
		                                     <div class="col-lg-3">
		                                         ...
		                                         <input  required="required" type="text" class="form-control " required="required"  name="score" id="score"   value="<?php echo ($info["score"]); ?>" onkeyup="value=value.replace(/[^\d]/g,'') "onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))"  > 
		                                     </div>
					                    </div>
					                     <div class='row'>
				 					         <label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;">企业日常图片1</label>
		                                     <div class="col-lg-2">
		                                         <input type="file" class="form-control"  name="imagelink1"  >
		                                     </div>
					                     ...
					                     <div class='row'>
		                                     ...
		                                     <div class="col-lg-2">
		                                         <input type="file" class="form-control"  name="imagelink2"  >
		                                     </div>
					                     ...
					                     <div class='row'>
		                                     ...
		                                     <div class="col-lg-2">
		                                         <input type="file" class="form-control"  name="imagelink3"  >
		                                     </div>
