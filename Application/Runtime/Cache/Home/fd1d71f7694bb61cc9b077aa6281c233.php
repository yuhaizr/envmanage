            ...
            <div class="widget">
                ...
                <div class="widget-body">
                    <div class="table-toolbar">
                    	...
                    	<div class='row'>
                    		   <div class='col-sm-2 div_middle'>
                    		   		原密码
                    		   </div>
	   			               <div class='col-sm-4'>
			                		<input type="text" value="<?php echo ($oldpass); ?>" id='oldpass' class="form-control"  placeholder="请输入原密码">
			                   </div>                	
                    	</div>
                    	<div class='row'>
                    		   <div class='col-sm-2 div_middle'>
	   			               ...
	   			               <div class='col-sm-4'>
			                		<input type="text" value="<?php echo ($newpass); ?>" id='newpass' class="form-control"  placeholder="请输入新密码">
			                   </div>                	
                    	</div>
                    	<div class ='row' style="margin-top: 40px;">
                    		<div class='col-sm-offset-3'>
                    			<a class='btn btn-info' id='mod_btn'> 修改</a>
                    		</div>
...
<script type="text/javascript">
	...
	$('#mod_btn').click(function(){
		...
		var data = {'oldpass':oldpass,'newpass':newpass,'type':'modpass'};
		
		$.ajax({
			url:"/envmanage/index.php/Home/User/modpass",
			type:"GET",
			data:data,
			dataType:'json',
			success:function(data){
				...
				if('0' == data.status){
					location.href = '/envmanage/index.php/Home/Login/index'
				}
			}
		});
	});
