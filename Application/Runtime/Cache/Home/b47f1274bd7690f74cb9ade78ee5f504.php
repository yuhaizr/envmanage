...
<head>
	...
	var __URL = '/envmanage/index.php/Home/ProwledObj';
	...
	<div class="col-xs-12 col-md-12">
	        <div class="widget">
	            <div class="widget-header ">
	                <span class="widget-caption">巡查对象列表</span>
	            ...
	            <div class="widget-body">
	      			...
	      			<form action="/envmanage/index.php/Home/ProwledObj/showList" method="get" >
	   	                 <div class="search-box col-sm-3" >
		                		<div>
		                			<span class="input-icon">
		                				<input type="text" name='searchValue' value="<?php echo ($searchValue); ?>" class="form-control" id="searchValue" placeholder="请输入对象名称">
	 					...
	 					<div class="col-sm-2">
		 					...
		 					<select  id='type_id_select' name='type_id' >
						    	...
						    	<?php if(is_array($type_list)): foreach($type_list as $key=>$vo): ?><option <?php if( $type_id == $vo["id"] ): ?>selected="selected"<?php endif; ?> value='<?php echo ($vo["id"]); ?>'><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
	                    ...
	                    <tbody id="tapeListTable">
	                    	<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
	                			...
	                			<td>
					   			...
					   			<?php if($my_modify_btn == '1'): ?><a href="/envmanage/index.php/Home/ProwledObj/modify?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"  class=" my_modify_btn btn btn-primary">修改</a>
								<?php else: ?>
								<a href="/envmanage/index.php/Home/ProwledObj/detail?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"  class=" my_detail_btn btn btn-primary">详情</a><?php endif; ?>
								
								<?php if($my_del_btn == '1'): ?><a href="/envmanage/index.php/Home/ProwledObj/del?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"    class=" my_del_btn btn btn-danger  delete">删除</a><?php endif; ?>
	                			</td>
