...
<!--                 <div class="page-breadcrumbs">
  ...
  <!--               <div class="page-header position-relative">
   ...
   <!--  					 <form action="/envmanage/index.php/Home/User/add" method="post"  >
					         ...
					         -->
					                    <div class='row'>
		                                     ...
		                                     <div class="col-lg-6">
		                                         <input disabled="disabled" required="required"  type="text" class="form-control"  name="account" id="account"  value="<?php echo ($info["account"]); ?>" >
					                    ...
					                    <div class='row'>
		                                     ...
		                                     <div class="col-lg-6">
		                                         <input  disabled="disabled" required="required"  type="text" class="form-control"  name="nickname" id="nickname"  value="<?php echo ($info["nickname"]); ?>" >
					                    ...
					                    <div class='row'>
					                    	<label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;">用户类别</label>
						 					<div class="col-sm-4">
					           		   				...
					           		   				<select  disabled="disabled" required="required"  id='type_id_select' name='type' >
					                    ...
					                    <div class='row'>
				                    		...
				                    		<div class="col-sm-4">
					           		   			<select  disabled="disabled" required="required"  id='type_id_select' name='sex' >
...
<!-- 				                    	 <div class='row'>
						 				 ...
						 				 <div class='row'>
		                                     ...
		                                     <div class="col-lg-4">
		                                         <input  disabled="disabled"   type="text" class="form-control"  name="addr" id="addr"  value="<?php echo ($info["addr"]); ?>" >
						 				 ...
						 				 <div class='row'>
		                                     ...
		                                     <div class="col-lg-6">
		                                         <input  disabled="disabled" readonly="readonly" type="text" class="form-control dateView"  name="birthday" id="birthday"   value="<?php echo ($info["birthday"]); ?>"  >
		                                     </div>
					                    </div>					                    
							 			<div class='row'>
				 					         <label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;">邮箱</label>
		                                     <div class="col-lg-6">
		                                         <input  disabled="disabled"  type="email" class="form-control"  name="email" id="email"  value="<?php echo ($info["email"]); ?>" >
		                                     </div>
					                    </div>				                    
							 			<div class='row'>
				 					         <label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;">电话号码</label>
		                                     <div class="col-lg-6">
		                                         <input   disabled="disabled" type="text" class="form-control"  name="phone" id="phone"  value="<?php echo ($info["phone"]); ?>" onkeyup="value=value.replace(/[^\d]/g,'') "onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" >
		                                     </div>
					                    </div>	
							 			<div class='row'>
				 					         <label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;">备注</label>
		                                     <div class="col-lg-6">
		                                         <input  disabled="disabled"  type="text" class="form-control"  name="mark" id="mark"  value="<?php echo ($info["mark"]); ?>" >
		                                     </div>
					                    </div>						                    					
