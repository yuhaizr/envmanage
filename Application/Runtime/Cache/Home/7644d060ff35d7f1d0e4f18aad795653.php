	...
	<div class="col-xs-12 col-md-12">
	        <div class="widget">
	            <div class="widget-header ">
	                <span class="widget-caption">地区日常巡查列表</span>
	                    	...
	                    	<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
		                        ...
		                        <td><?php echo ($vo["level"]); ?></td>   
		                			...
		                			<td>
						   			...
						   			<?php if($my_modify_btn == '1'): ?><a href="/envmanage/index.php/Home/AreaProwled/modify?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"  class=" my_modify_btn btn btn-primary">修改</a>
									<?php else: ?>
									<a href="/envmanage/index.php/Home/AreaProwled/detail?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"  class=" my_detail_btn btn btn-primary">详情</a><?php endif; ?>
									
									<?php if($my_del_btn == '1'): ?><a href="/envmanage/index.php/Home/AreaProwled/del?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"    class=" my_del_btn btn btn-danger  delete">删除</a><?php endif; ?>
		                			</td>
