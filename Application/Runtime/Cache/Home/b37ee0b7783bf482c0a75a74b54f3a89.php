	...
	<div class="col-xs-12 col-md-12">
	        <div class="widget">
	            <div class="widget-header ">
	                <span class="widget-caption">企业日常巡查列表</span>
	            ...
	            <div class="widget-body">
	      			...
	      			<form action="/envmanage/index.php/Home/BizProwled/showList" method="get" >
	   	                 <div class="search-box col-sm-2" >
	 						<select  id='business_id_select' name='business_id' >
						    	<option value=''> 请选择公司</option>
						    	<?php if(is_array($business_list)): foreach($business_list as $key=>$vo): ?><option <?php if( $business_id == $vo["id"] ): ?>selected="selected"<?php endif; ?> value='<?php echo ($vo["id"]); ?>'><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
	 					...
	 					<div class="col-sm-2">
		 					...
		 					<select  id='prowled_obj_id_select' name='prowled_obj_id' >
						    	...
						    	<?php if(is_array($biz_prowled_obj_list)): foreach($biz_prowled_obj_list as $key=>$vo): ?><option <?php if( $prowled_obj_id == $vo["id"] ): ?>selected="selected"<?php endif; ?> value='<?php echo ($vo["id"]); ?>'><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
	                ...
	                <table class="table table-striped table-hover table-bordered" id="editabledatatable">
	                    ...
	                    <tbody id="tapeListTable">
	                    	<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
		                        ...
		                        <td><?php echo ($vo["prowled_obj_id"]); ?></td> 
		                        <td><?php echo ($vo["score"]); ?></td>  
		                        <td><?php echo ($vo["level"]); ?></td>   
		         
		                			<td>
		                		
						   			<?php if($my_modify_btn == '1'): ?><a href="/envmanage/index.php/Home/BizProwled/modify?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"  class=" my_modify_btn btn btn-primary">修改</a>
									<?php else: ?>
									<a href="/envmanage/index.php/Home/BizProwled/detail?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"  class=" my_detail_btn btn btn-primary">详情</a><?php endif; ?>
									
									<?php if($my_del_btn == '1'): ?><a href="/envmanage/index.php/Home/BizProwled/del?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"    class=" my_del_btn btn btn-danger  delete">删除</a><?php endif; ?>
		                			</td>
