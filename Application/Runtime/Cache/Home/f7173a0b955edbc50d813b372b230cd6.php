...
<head>
	...
	var __URL = '/hotel/index.php/Home/ScenicSpot';
	...
	<div class="col-xs-12 col-md-12">
	        <div class="widget">
	            ...
	            <div class="widget-body">
	      			...
	      			<form action="/hotel/index.php/Home/ScenicSpot/showList" method="get" >
	                ...
	                <table class="table table-striped table-hover table-bordered" id="editabledatatable">
	                    ...
	                    <tbody id="tapeListTable">
	                    	<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
		                			...
		                			<a href="/hotel/index.php/Home/ScenicSpot/detail?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"  class=" my_detail_btn btn btn-primary">详情</a>
		           					<a href="/hotel/index.php/Home/ScenicSpot/modify?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button" style="display: none;" class=" my_modify_btn btn btn-primary">修改</a>
		           					<a href="/hotel/index.php/Home/ScenicSpot/del?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"    style="display: none;" class=" my_del_btn btn btn-danger  delete">删除</a>
		                			</td>
			                   ...
			                   <!--未开户成功用户接单记录表开始  -->
			               	   <div class="widget">
						           ...
						           <div class="widget-body">
					                    ...
					                    <form action="/hotel/index.php/Home/ScenicSpot/addContractType" method="post" >
...
<script type="text/javascript">
	...
	$(".del_product").click(function(){
		...
		if(wcglid){
			location.href = '/hotel/index.php/Home/ScenicSpot/delProductJd?type=menu&id='+wcglid;
		}else{
			alert('参数缺失');
		}
