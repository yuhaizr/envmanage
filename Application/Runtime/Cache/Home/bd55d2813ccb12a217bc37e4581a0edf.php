	...
	<div class="col-xs-12 col-md-12">
	        <div class="widget">
	            ...
	            <div class="widget-body">
	      			...
	      			<form action="/hotel/index.php/Home/Hotel/showList" method="get" >
	                ...
	                <table class="table table-striped table-hover table-bordered" id="editabledatatable">
	                    ...
	                    <tbody id="tapeListTable">
	                    	<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
		                            ...
		                            <td><?php echo ($vo["in_time"]); ?></td>
		                            <td><?php echo ($vo["out_time"]); ?></td>
		                            <td><?php echo ($vo["link"]); ?></td>
		                            <td>
		                            <?php if(!empty($vo['imglink'])): ?><img class='imgdiv' alt="单击查看大图" style="width: 100px;50px;" src="/hotel/<?php echo ($vo['imglink']); ?>"><?php endif; ?>
		                            </td>
		                            
		          
		                			<td>
		                		
		                			<a href="/hotel/index.php/Home/Hotel/detail?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"  class=" my_detail_btn btn btn-primary">详情</a>
		           					<a href="/hotel/index.php/Home/Hotel/modify?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button" style="display: none;" class=" my_modify_btn btn btn-primary">修改</a>
		           					<a href="/hotel/index.php/Home/Hotel/del?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"    style="display: none;" class=" my_del_btn btn btn-danger  delete">删除</a>
		                			</td>
