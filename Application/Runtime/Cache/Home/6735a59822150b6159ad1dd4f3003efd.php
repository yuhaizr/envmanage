...
<head>
	...
	var __URL = '/envmanage/index.php/Home/Notice';
                 ...
                 <div class="col-xs-12">
                     <div class="widget radius-bordered">
                         <div class="widget-header">
                             <span class="widget-caption">公告信息</span>      
                         </div>
                         <div class="widget-body">
                          
    
    					 <form action="/envmanage/index.php/Home/Notice/save" method="post"  ><!--enctype="multipart/form-data"  -->
    					 				<?php if(!empty($info)): ?><input type="hidden" class="form-control"  name="id" value="<?php echo ($info["id"]); ?>" ><?php endif; ?>
					        
					                    <div class='row'>
				 					         <label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;">公告内容</label>
		                                     <div class="col-lg-6">
		                                         <input type="text" class="form-control"  name="content" id="content" required="required" value="<?php echo ($info["content"]); ?>" >
						                 ...
						                 <div class='row'>
				 					         <label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;">开始时间</label>
		                                     <div class="col-lg-6">
		                                         <input type="datetime-local" class="form-control"  name="starttime" id="starttime" required="required" value="<?php echo ($info["starttime"]); ?>" >
						                 ...
						                 <div class='row'>
				 					         <label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;">结束时间</label>
		                                     <div class="col-lg-6">
		                                         <input type="datetime-local" class="form-control"  name="endtime" id="endtime" required="required" value="<?php echo ($info["endtime"]); ?>" >
					                     ...
					                     <div class='row'>
				 					         <label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;">是否在banner显示</label>
		                                     <div class="col-lg-6">
		                                        <select name='is_show'>
		                                        	<option <?php if($info['is_show'] == '1'): ?>selected="selected"<?php endif; ?> value='1' >是</option>
		                                        	<option <?php if($info['is_show'] == '0'): ?>selected="selected"<?php endif; ?> value='0' >否</option>
					     				 ...
					     				 <div class='row' style="margin-top: 20px;margin-bottom: 20px;">
					                    	...
					                    	<input class="btn btn-palegreen" type="submit" id="saveRecord" value="保存公告">
					                    	</div>
					                    </div>
					               		</form>
