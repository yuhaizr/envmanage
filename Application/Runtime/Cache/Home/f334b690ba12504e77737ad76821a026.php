...
<head>
	...
	var __URL = '/envmanage/index.php/Home/BizProwled';
                 ...
                 <div class="col-xs-12">
                     <div class="widget radius-bordered">
                         <div class="widget-header">
                             <span class="widget-caption">企业日常巡查信息</span>      
                         </div>
                         <div class="widget-body">
                          
    
<!--     					 <form id='form_div' action="/envmanage/index.php/Home/BizProwled/add" method="post" enctype="multipart/form-data" >
			        					...
			        					<div class='row'>
		                                     ...
		                                     <div class="col-lg-3">
		                                         ...
		                                         <input disabled="disabled"  readonly="readonly"  type="text" class="form-control dateView " required="required"  name="date" id="date"   value="<?php echo ($info["date"]); ?>"  > 
		                                     </div>
					                    </div>
			        					<div class='row'>
				 					         <label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;" >公司</label>
		                                     <div class="col-lg-3">
		                                   
		                                      	<select disabled="disabled" required="required"  id='business_id_select' name='business_id' >
											    	<option value=''> 请选择公司</option>
											    	<?php if(is_array($business_list)): foreach($business_list as $key=>$vo): ?><option <?php if($info['business_id'] == $vo["id"] ): ?>selected="selected"<?php endif; ?> value='<?php echo ($vo["id"]); ?>'><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
					                    ...
					                    <div class='row'>
				 					         <label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;" >巡查对象</label>
		                                     <div class="col-lg-3">
		                            
		                                      	<select  disabled="disabled" required="required"  id='prowled_obj_id_select' name='prowled_obj_id' >
		                                      	
											    	<option value=''> 请选择巡查对象</option>
											    	<?php if(is_array($biz_prowled_obj_list)): foreach($biz_prowled_obj_list as $key=>$vo): ?><option <?php if( $info['prowled_obj_id'] == $vo["id"] ): ?>selected="selected"<?php endif; ?> value='<?php echo ($vo["id"]); ?>'><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
											    	
										 		</select>  
		                                     </div>
					                    </div>					                    
					           			<div class='row'>
				 					         <label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;" >分数</label>
		                                     <div class="col-lg-3">
		                                   
		                                         <input disabled="disabled"  required="required" type="text" class="form-control " required="required"  name="score" id="score"   value="<?php echo ($info["score"]); ?>" onkeyup="value=value.replace(/[^\d]/g,'') "onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))"  > 
		                                     </div>
					                    </div>
					                     <div class='row'>
				 					         <label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;">企业日常图片1</label>
		                                     <div class="col-lg-2">
		                                         <input disabled="disabled" type="file" class="form-control"  name="imagelink1"  >
		                                     </div>
		                                     <?php if(!empty($info['imagelink1'])): ?><div class="col-lg-2">
		                                     	<img class='imgdiv' alt="单击查看大图" style="width: 150px;100px;" src="/envmanage/<?php echo ($info['imagelink1']); ?>">
		                                     </div><?php endif; ?>
					                    </div>	
					                     <div class='row'>
				 					         <label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;">企业日常图片2</label>
		                                     <div class="col-lg-2">
		                                         <input disabled="disabled" type="file" class="form-control"  name="imagelink2"  >
		                                     </div>
		                                     <?php if(!empty($info['imagelink2'])): ?><div class="col-lg-2">
		                                     	<img class='imgdiv' alt="单击查看大图" style="width: 150px;100px;" src="/envmanage/<?php echo ($info['imagelink2']); ?>">
		                                     </div><?php endif; ?>
					                    </div>	
					                    
					                     <div class='row'>
				 					         <label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;">企业日常巡查图片3</label>
		                                     <div class="col-lg-2">
		                                         <input disabled="disabled" type="file" class="form-control"  name="imagelink3"  >
		                                     </div>
		                                     <?php if(!empty($info['imagelink3'])): ?><div class="col-lg-2">
		                                     	<img class='imgdiv' alt="单击查看大图" style="width: 150px;100px;" src="/envmanage/<?php echo ($info['imagelink3']); ?>">
		                                     </div><?php endif; ?>
					                    </div>						                    					
					                     <div class='row'>
					     ...
					     <!-- 				 <div class='row' style="margin-top: 20px;margin-bottom: 20px;">
					                    	...
					                    	<input class="btn btn-palegreen" type="submit" id="saveRecord" value="保存企业日常巡查信息">
					                    	</div>
					                    </div>
					               		</form> -->
...
$(".bfjl_img").click(function(){
	...
	location.href = "/envmanage/Home/Upload/downFile?filepath="+filepath;
});
