             ...
             <div class="row">
                 <div class="col-xs-12">
                     <div class="widget radius-bordered">
    					 ...
    					 <form action="/hotel/index.php/Home/User/save" method="post"  ><!--enctype="multipart/form-data"  -->
					                    ...
					                    <div class='row'>
		                                     ...
		                                     <div class="col-lg-6">
		                                         <input type="text" class="form-control" readonly="readonly"  name="account" id="account" required="required" value="<?php echo ($info["account"]); ?>" >
					                     ...
					                     <div class='row'>
		                                     ...
		                                     <div class="col-lg-6">
		                                         ...
		                                         <input type="email" class="form-control"   name="email" id="email" required="required" value="<?php echo ($info["email"]); ?>" >
					      				 ...
					      				 <div class='row'>
		                                     ...
		                                     <div class="col-lg-6">
		                                         ...
		                                         <input type="password" class="form-control"   name="password" id="password" required="required" value="<?php echo ($info["password"]); ?>" >
