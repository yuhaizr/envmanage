                 ...
                 <div class="col-xs-12">
                     <div class="widget radius-bordered">
                         <div class="widget-header">
                             <span class="widget-caption">地区日常巡查信息</span>      
                         </div>
                         <div class="widget-body">
                          
    
    					 <form id='form_div' action="/envmanage/index.php/Home/AreaProwled/save" method="post" enctype="multipart/form-data" ><!--  -->
					                    ...
					                    <div class='row'>
		                                     ...
		                                     <div class="col-lg-3">
		                                      	...
		                                      	<select  required="required"  id='prowled_obj_id_select' name='prowled_obj_id' >
											    	...
											    	<?php if(is_array($area_prowled_obj_list)): foreach($area_prowled_obj_list as $key=>$vo): ?><option <?php if( $info['prowled_obj_id'] == $vo["id"] ): ?>selected="selected"<?php endif; ?> value='<?php echo ($vo["id"]); ?>'><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
					                     ...
					                     <div class='row'>
				 					         <label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;">地区日常巡查图片1</label>
		                                     <div class="col-lg-2">
					                     ...
					                     <div class='row'>
				 					         <label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;">地区日常巡查图片2</label>
		                                     <div class="col-lg-2">
					                     ...
					                     <div class='row'>
				 					         <label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;">地区日常巡查图片3</label>
		                                     <div class="col-lg-2">
					                     ...
					                     <div class='row'>
					     				 ...
					     				 <div class='row' style="margin-top: 20px;margin-bottom: 20px;">
					                    	...
					                    	<input class="btn btn-palegreen" type="submit" id="saveRecord" value="保存地区日常巡查信息">
					                    	</div>
					                    </div>
					               		</form>
