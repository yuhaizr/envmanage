                 ...
                 <div class="col-xs-12">
                     <div class="widget radius-bordered">
                         <div class="widget-header">
                             <span class="widget-caption">巡查对象信息</span>      
                         </div>
                         <div class="widget-body">
                          
    
    					 <form action="/envmanage/index.php/Home/ProwledObj/save" method="post"  ><!--enctype="multipart/form-data"  -->
    					 				<?php if(!empty($info)): ?><input type="hidden" class="form-control"  name="id" value="<?php echo ($info["id"]); ?>" ><?php endif; ?>
					        
					                    <div class='row'>
				 					         <label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;">类别名称</label>
		                                     <div class="col-lg-6">
					                    ...
					                    <div class='row'>
					                    	<label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;">公司类别</label>
						 					<div class="col-sm-4">
							 					...
							 					<select required="required"  id='type_id_select' name='type_id' >
											    	...
											    	<?php if(is_array($type_list)): foreach($type_list as $key=>$vo): ?><option <?php if( $info['type_id'] == $vo["id"] ): ?>selected="selected"<?php endif; ?> value='<?php echo ($vo["id"]); ?>'><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
					                     ...
					                     <div class='row'>
					     				 ...
					     				 <div class='row' style="margin-top: 20px;margin-bottom: 20px;">
					                    	...
					                    	<input class="btn btn-palegreen" type="submit" id="saveRecord" value="保存巡查类别">
					                    	</div>
					                    </div>
					               		</form>
