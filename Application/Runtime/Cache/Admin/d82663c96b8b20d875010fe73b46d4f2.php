...
<head>
	...
	var __URL = '/envmanage/index.php/Admin/Business';
	...
	<div class="col-xs-12 col-md-12">
	        <div class="widget">
	            <div class="widget-header ">
	                <span class="widget-caption">公司列表</span>
	            ...
	            <div class="widget-body">
	      			...
	      			<form action="/envmanage/index.php/Admin/Business/showList" method="get" >
	   	                 <div class="search-box col-sm-3" >
		                		<div>
		                			<span class="input-icon">
		                				<input type="text" name='searchValue' value="<?php echo ($searchValue); ?>" class="form-control" id="searchValue" placeholder="请输入公司名称">
	 					...
	 					<div class="col-sm-2">
		 					...
		 					<select  id='type_id_select' name='type_id' >
						    	<option value=''> 请选择公司类别</option>
						    	<?php if(is_array($business_type_list)): foreach($business_type_list as $key=>$vo): ?><option <?php if( $type_id == $vo["id"] ): ?>selected="selected"<?php endif; ?> value='<?php echo ($vo["id"]); ?>'><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
	                    ...
	                    <tbody id="tapeListTable">
	                    	<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
		                        ...
		                        <td><?php echo ($vo["legal_person_phone"]); ?></td>   
		          				<td><?php echo ($vo["business_license"]); ?></td>
		                			<td>
		                		
						   			<?php if($my_modify_btn == '1'): ?><a href="/envmanage/index.php/Admin/Business/modify?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"  class=" my_modify_btn btn btn-primary">修改</a>
									<?php else: ?>
									<a href="/envmanage/index.php/Admin/Business/detail?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"  class=" my_detail_btn btn btn-primary">详情</a><?php endif; ?>
									
									<?php if($my_del_btn == '1'): ?><a href="/envmanage/index.php/Admin/Business/del?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"    class=" my_del_btn btn btn-danger  delete">删除</a><?php endif; ?>
		                			</td>
