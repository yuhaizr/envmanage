                 ...
                 <div class="col-xs-12">
                     <div class="widget radius-bordered">
                         <div class="widget-header">
                             <span class="widget-caption">公司类别信息</span>      
                         </div>
                         <div class="widget-body">
                          
    
    					 <form action="/envmanage/index.php/Admin/BusinessType/save" method="post"  ><!--enctype="multipart/form-data"  -->
    					 				<?php if(!empty($info)): ?><input type="hidden" class="form-control"  name="id" value="<?php echo ($info["id"]); ?>" ><?php endif; ?>
					        
					                    <div class='row'>
				 					         <label class="col-lg-2 control-label" style="height: 34px;line-height: 34px;text-align: right;">公司类型名称</label>
		                                     <div class="col-lg-6">
...
<script src="/envmanage/Public/js/datetime/bootstrap-datepicker.js"></script>
