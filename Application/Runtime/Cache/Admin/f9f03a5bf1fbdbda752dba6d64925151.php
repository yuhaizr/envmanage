...
<head>
	...
	var __URL = '/envmanage/index.php/Admin/User';
	...
	<div class="col-xs-12 col-md-12">
	        <div class="widget">
	            ...
	            <div class="widget-body">
	      			...
	      			<form action="/envmanage/index.php/Admin/User/showList" method="get" >
   	                 <div class="search-box col-sm-3" >
	  					...
	  					<div class="col-lg-2">
           		   				...
           		   				<select  id='type_id_select' name='type' >
							    	<option   value="" >请选择用户类型</option>
							    	<?php if(is_array($user_type_list)): foreach($user_type_list as $key=>$vo): ?><option <?php if( $type == $vo["id"] ): ?>selected="selected"<?php endif; ?> value='<?php echo ($vo["id"]); ?>'><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
	                ...
	                <table class="table table-striped table-hover table-bordered" id="editabledatatable">
	                    ...
	                    <tbody id="tapeListTable">
	                    	<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
		                			...
		                			<a href="/envmanage/index.php/Admin/User/detail?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"  class=" my_detail_btn btn btn-primary">详情</a>
		           					<a href="/envmanage/index.php/Admin/User/modify?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button" style="display: none;" class=" my_modify_btn btn btn-primary">修改</a>
		           					<a href="/envmanage/index.php/Admin/User/del?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"    style="display: none;" class=" my_del_btn btn btn-danger  delete">删除</a>
		                			</td>
