             ...
             <div class="row">
                 <div class="col-xs-12">
                     <div class="widget radius-bordered">
    					 ...
    					 <form action="/envmanage/index.php/Admin/Business/save" method="post"  ><!--enctype="multipart/form-data"  -->
					                    ...
					                    <div class='row'>
						 				 ...
						 				 <div class='row'>
		                                     ...
		                                     <div class="col-lg-6">
		                                         <input type="text" class="form-control dateView"  name="cdate" id="cdate"   value="<?php echo ($info["cdate"]); ?>"  >
		                                     </div>
					                    </div>					                    
							 			<div class='row'>
							 			...
							 			<div class='row'>
		                                     ...
		                                     <div class="col-lg-6">
		                                         <input   type="text" class="form-control"  name="legal_person_phone" id="legal_person_phone"  value="<?php echo ($info["legal_person_phone"]); ?>" >
		                                     </div>
					                    </div>	
							 			<div class='row'>
