...
<head>
	...
	var __URL = '/envmanage/index.php/Admin/BusinessType';
	...
	<div class="col-xs-12 col-md-12">
	        <div class="widget">
	            <div class="widget-header ">
	                <span class="widget-caption">公司类别列表</span>
	            ...
	            <div class="widget-body">
	      			...
	      			<form action="/envmanage/index.php/Admin/BusinessType/showList" method="get" >
   	                 <div class="search-box col-sm-3" >
	                		<div>
	                			<span class="input-icon">
	                				<input type="text" name='searchValue' value="<?php echo ($searchValue); ?>" class="form-control" id="searchValue" placeholder="请输入类型名称：">
	                    	...
	                    	<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
							    ...
							    <td><?php echo ($vo["mark"]); ?></td>
		                			...
		                			<td>
						   			...
						   			<?php if($my_modify_btn == '1'): ?><a href="/envmanage/index.php/Admin/BusinessType/modify?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"  class=" my_modify_btn btn btn-primary">修改</a>
									<?php else: ?>
									<a href="/envmanage/index.php/Admin/BusinessType/detail?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"  class=" my_detail_btn btn btn-primary">详情</a><?php endif; ?>
									
									<?php if($my_del_btn == '1'): ?><a href="/envmanage/index.php/Admin/BusinessType/del?type=menu&id=<?php echo ($vo["id"]); ?>" data-bb-handler="confirm" type="button"    class=" my_del_btn btn btn-danger  delete">删除</a><?php endif; ?>
		                			</td>
